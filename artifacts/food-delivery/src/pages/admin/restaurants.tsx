...
import { ArrowLeft, Award, Plus, Pencil, Trash2, UtensilsCrossed } from "lucide-react";
          ...
          <DialogContent className="max-w-lg">
            ...
            <div className="grid gap-3">
              ...
              <div>
                ...
                <Input value={form.imageUrl} onChange={(e) => setForm({ ...form, imageUrl: e.target.value })} placeholder="https://..." className="mt-1" data-testid="input-image-url" />
                {form.imageUrl && (
